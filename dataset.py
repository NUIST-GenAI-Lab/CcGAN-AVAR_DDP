...
class LoadDataSet:
    def __init__(self, data_name, data_path, min_label, max_label, img_size=64, max_num_img_per_label=1e30,
                 num_img_per_label_after_replica=0, imbalance_type="unimodal"):
        """
    ...
    def load_train_data(self):
        ...
        if self.data_name == "RC-49":
            ...
            max_num_img_per_label_after_replica = np.min(
                [self.num_img_per_label_after_replica, self.max_num_img_per_label])
            ...
            step_size = 2
            selected_labels = np.arange(self.min_label, self.max_label + 1,
                                        step_size)  # only take images with odd labels for training
...
if __name__ == "__main__":
    ...
    handler = LoadDataSet(data_name="RC-49", data_path=file_path, min_label=0, max_label=90, img_size=64,
                          max_num_img_per_label=25, num_img_per_label_after_replica=0)
